...
/******************************adjust the three parameters to control speed ****************************/
    ...
    midpoint_joint_state << 0, -1.2, 0.45, 0, 0.8, 0;  // further from the obstacle
    ...
    double timeperiod_r2b = 6; // the time spent from red ball to blue ball (same time spent on blue to red)
/******************************adjust the three parameters to control speed****************************/
